...
public class MergeSourceViewer implements ISelectionChangedListener, ITextListener, IMenuListener, IOperationHistoryListener, IAdaptable {
	// mksong Dec 31, 2013 12:45:40 PM
	...
	private void addSave(IMenuManager menu) {
		...
		if (handler != null) {
			if (fSaveContributionItem == null) {
				fSaveContributionItem = new CommandContributionItem(new CommandContributionItemParameter(fContainer.getWorkbenchPart().getSite(), null, command.getId(),
