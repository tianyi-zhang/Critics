...
public final class CompareUI {
	 ...
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_DTOOL_NEXT			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.DTOOL_NEXT);
	/**
	 * Image descriptor for the normal icon of the 'Next' tool bar button.
	 * 
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_CTOOL_NEXT			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.CTOOL_NEXT);
	/**
	 * Image descriptor for the roll-over icon of the 'Next' tool bar button.
	 * 
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_ETOOL_NEXT			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.ETOOL_NEXT);
	 ...
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_DTOOL_PREV			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.DTOOL_PREV);
	/**
	 * Image descriptor for the normal icon of the 'Previous' tool bar button.
	 * 
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_CTOOL_PREV			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.CTOOL_PREV);
	/**
	 * Image descriptor for the roll-over icon of the 'Previous' tool bar button.
	 * 
	 * @since 2.0
	 */
	public static final ImageDescriptor	DESC_ETOOL_PREV			= CompareUIPlugin
																		.getImageDescriptor(ICompareUIConstants.ETOOL_PREV);
	 ...
	 * 
	 * @param adaptable
	 *            the adaptable for which to find an image
	 * @return an image
	 */
	 ...
	 * 
	 * @param type
	 *            the type for which to find a stream merger
	 * @return a stream merger for the given type, or <code>null</code> if no
	 *         stream merger has been registered
	 * @deprecated Clients should obtain an <code>org.eclipse.team.core.mapping.IStorageMerger</code> from the <code>org.eclipse.team.core.Team#createMerger(IContentType)</code> method.
	 */
	 ...
	 * @return a stream merger for the given type, or <code>null</code> if no
	 *         stream merger has been registered
	 * @deprecated Clients should obtain an <code>org.eclipse.team.core.mapping.IStorageMerger</code> from the <code>org.eclipse.team.core.Team#createMerger(String)</code> method.
	 */
	 ...
	 * @param configuration
	 *            a configuration which is passed to a newly created viewer
	 ...
	 *            a new viewer is only created if this old viewer cannot show the given input
	 * @param input
	 *            the input object for which to find a content viewer
	 * @param parent
	 *            the SWT parent composite under which the new viewer is created
	 * @param configuration
	 *            a configuration which is passed to a newly created viewer
	 ...
	 * and ITypedElement or ICompareInput. If no viewer descriptor can be found <code>null</code> is returned.
	 * 
	 * @param oldViewer
	 *            a new viewer is only created if this old viewer cannot show the given input
	 * @param input
	...
	/**
	 * Adds an alias for the given type. Subsequent calls to <code>findStructureViewer</code> treat alias as a synonym for type and
	 ...
	 * 
	 * @param input
	 *            the object for which to retrieve a document
	 ...
	 * 
	 * @param input
	 *            the object for which to register a document
	 * @param document
