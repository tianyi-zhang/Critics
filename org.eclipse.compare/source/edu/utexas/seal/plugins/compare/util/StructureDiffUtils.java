...
public final class StructureDiffUtils {
	...
	/**
	 * Compares two {@link IFile}s with each other by using the Eclipse compare facilities and returns the root {@link DiffNode} of the differences.
	 * 
	 * @param left
	 *            file to compare
	 * @param right
	...
	/**
	 * Returns the next class or interface {@link DiffNode} within the given hierarchical {@link IDiffElement} structure.
	 * 
	 * @param elements
	 ...
	 * @param diffNode
	 *            that represents the operation
	 * @return <code>true</code> if diff node represents an neither an insert nor a delete operation, <code>false</code> otherwise.
	 */
	 ...
	 * @param diffNode
	 *            that represents the operation
	 * @return <code>true</code> if the entity in the diff node is a class or an interface, <code>false</code> otherwise.
	 */
	 ...
	 * @param documentRangeNode
	 *            that represents a range in a document
	 * @return <code>true</code> if the entity in the document range node is a class or an interface, <code>false</code> otherwise.
	 */
	 ...
	 * @param diffNode
	 *            that represents the operation
	 * @return <code>true</code> if the entity in the diff node is a constructor or a method, <code>false</code> otherwise.
	 */
	public static boolean isMethodOrConstructor(DiffNode diffNode) {
		DocumentRangeNode drn = (DocumentRangeNode) diffNode.getId();
		return (drn.getTypeCode() == StructureDiffUtils.METHOD) || (drn.getTypeCode() == StructureDiffUtils.CONSTRUCTOR);
	}
	 ...
	 * @param documentRangeNode
	 *            that represents a range in a document
	 * @return <code>true</code> if the entity in the document range node is a constructor or a method, <code>false</code> otherwise.
	 */
	...
	private static DiffNode compare(IStructureComparator left, IStructureComparator right) {
		...
		Object structureDiffs = differencer.findDifferences(false /*three way*/, null /*progress monitor*/, null /*data object*/, null /*ancestor*/, left, right);
